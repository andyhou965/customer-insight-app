...
pyoff.iplot(monthly_revenue_fig)
...
pyoff.iplot(monthly_growth_fig)
...
pyoff.iplot(monthly_active_customers_fig)
# %%
...
pyoff.iplot(monthly_order_number_fig)
...
pyoff.iplot(monthly_avg_order_fig)
# %%
